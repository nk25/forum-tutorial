<?php
	...
	function disptopics($cid, $scid) {
		include ('dbconn.php');
		$select = mysqli_query($con, "SELECT topic_id, author, title, date_posted, views, FROM topics,  categories, subcategories 
		...
		if (mysqli_num_rows($select) != 0) {
			...
			echo "<p>this category has no topics yet!  <a href='/forum-tutorial/newtopic.php/?cid=".$cid."&scid=".$scid."'>
